...
def main():
    ...
    lr = 0.0001
    model_idx = -1
    model_folder = 'CorrXCA_ncc_{}_reg_{}_lr_{}_54r/'.format(*weights, lr)
    model_dir = 'experiments/' + model_folder

    img_size = (160, 192, 160)
    model = CorrXCA(in_channels=1, enc_channels=12, dec_channels=24, num_heads=[16,8,4,2], region_size=6)
